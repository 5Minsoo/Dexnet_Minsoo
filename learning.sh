...
datapath="/home/minsoo/Dexnet_Minsoo/grasp_dataset_0408.zarr"
epoch=20
python3 Minsoo_net/model/train.py --data $datapath --thresh 0.002 2>&1 --epochs $epoch --loss "CE"
python3 Minsoo_net/model/train.py --data $datapath --thresh 0.034 2>&1 --epochs $epoch --loss "CE"
